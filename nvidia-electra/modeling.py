...
class TFElectraClassificationHead(tf.keras.layers.Layer):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.out_proj = tf.keras.layers.Dense(
            config.num_labels,activation="softmax", kernel_initializer=get_initializer(config.initializer_range), name="out_proj"
        )
...
class TFElectraForSequenceClassification(TFElectraPreTrainedModel):
    ...
    @add_start_docstrings_to_callable(ELECTRA_START_DOCSTRING)    
    def call(self,inputs,**kwargs):
        r"""
