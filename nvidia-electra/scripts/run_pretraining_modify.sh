...
DATA_DIR_P1=${21:-"/workspace/electra/pretrain_tfrecord/seq_128/train/pretrain_data*"}  # change this for other datasets
DATA_DIR_P2=${21:-"/workspace/electra/pretrain_tfrecord/seq_512/train/pretrain_data*"} # change this for other datasets
CODEDIR=${23:-"/workspace/electra"}
init_checkpoint=${24:-"None"}
restore_checkpoint=${restore_checkpoint:-"true"}
RESULTS_DIR=$CODEDIR/results

echo "$train_batch_size_p1 $learning_rate_p1 $precision"
...
CMD+=" --max_seq_length=128 --disc_weight=50.0"
...
CMD+=" --max_seq_length=512 --disc_weight=50.0 ${RESTORE_CHECKPOINT}"
