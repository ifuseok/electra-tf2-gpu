...
# Full pretraining configs for NVIDIA DGX-1 (4x NVIDIA V100 16GB GPU)
...
dgx1_4gpu_amp ()
{
    ...
    optimizer="lamb"
    accumulate_gradients="true"
    gradient_accumulation_steps_p1=192
    seed=42
    job_name="electra_lamb_pretraining"
    train_batch_size_p2=12
    learning_rate_p2="4e-3"
...
dgx1_4gpu_fp32 ()
{
    ...
    optimizer="lamb"
    accumulate_gradients="true"
    gradient_accumulation_steps_p1=422
    seed=42
    job_name="electra_lamb_pretraining"
    train_batch_size_p2=6
    learning_rate_p2="4e-3"
...
# Full pretraining configs for NVIDIA DGX-1 (4x NVIDIA VRAM 12GB GPU)
dgx1_2_4gpu_amp ()
{
    train_batch_size_p1="66"
    learning_rate_p1="6e-3"
    precision="amp"
    xla="xla"
    num_gpus=4
    ...
    optimizer="lamb"
    accumulate_gradients="true"
    gradient_accumulation_steps_p1=256
    seed=42
    job_name="electra_lamb_pretraining"
    train_batch_size_p2=9
    learning_rate_p2="4e-3"
    warmup_steps_p2="200"
    train_steps_p2=933
    gradient_accumulation_steps_p2=768
    electra_model="base"
    echo $train_batch_size_p1 $learning_rate_p1 $precision $num_gpus $xla \
         $warmup_steps_p1 $train_steps_p1 $save_checkpoint_steps \
         $resume_training $optimizer $accumulate_gradients  \
...
rtx60_4gpu_amp_small ()
{
    train_batch_size_p1="132"
    learning_rate_p1="6e-3"
    precision="amp"
    xla="xla"
    num_gpus=4
